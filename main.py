...
#movie_df.head()----(to print first five lines of data set)

#credit_df.head()----(to print first five lines of data set)
...
#movie_df['cast'].head()----(to print first five lines of data set)


#getting director names using module
movie_df['Director']=movie_df['crew'].apply(director.get_director)

#converting to list using module
...
#movie_df[['title', 'cast', 'Director', 'keywords', 'genres']].head()----(to print first five lines of data set)


#cleaning data (removing spaces) using module
...
#joining data from columns
movie_df['soup']=movie_df.apply(joining.create_soup, axis=1)
#movie_df['soup'].head()----(to print first five lines of data set)
...
#print(indices.head())----(to print first five lines of data set)
